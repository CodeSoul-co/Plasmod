...
func TestPlasmodStandardPorts(t *testing.T) {
	if PortMgmt != 9101 || PortAPI != 19540 || PortObjectStore != 9010 || PortObjectStoreConsole != 9011 {
...
func TestResolveListenConfig_split(t *testing.T) {
	...
	cfg := ResolveListenConfig()
	if cfg.Mode != ListenModeSplit || cfg.MgmtAddr != "0.0.0.0:9101" || cfg.APIAddr != "0.0.0.0:19540" {
