...
#include <sstream>
#include <iostream>
namespace andb_log_detail {
struct LogStream {
    int sev; const char* file; int line;
...
#define DLOG(sev)    if(false) andb_log_detail::NullStream()
#define VLOG(n)      if(false) andb_log_detail::NullStream()
#define INFO    0
#define WARNING 1
#define ERROR   2
#define FATAL   3
